...
public class DownloadMng extends HttpServlet implements ServiceConstant {
	...
	public void addAttachmentForOneUser(String userId) {
		...
		for (Attachment att : list) {
			String fileName = att.createDownloadFileName(userId);
			try {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (String userId : aUserId) {
			addAttachmentForOneUser(userId);
		}
		zipOs.close();

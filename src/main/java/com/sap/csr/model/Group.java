...
//	 transient private 
	...
	public EntityManager getEntityManager() {
		...
		try {
			...
			EntityManager em = JpaEntityManagerFactory.getEntityManagerFactory().createEntityManager(properties);
			return em; 
	...
	public void autoGetMemberList() {
		...
		String regQueryStr = "select userId, lastName, firstName from Registration r where r.groupId = :groupId";
